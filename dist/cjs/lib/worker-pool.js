...
exports.getDefaultWorkerCount = exports.TranspileWorkerPool = void 0;
const node_worker_threads_1 = require("node:worker_threads");
const os = require("node:os");
class TranspileWorkerPool {
    constructor(size) {
        this.workers = [];
        this.idle = [];
        this.queue = [];
    ...
    spawn(index) {
        const worker = new node_worker_threads_1.Worker(WORKER_CODE, { eval: true });
...
exports.TranspileWorkerPool = TranspileWorkerPool;
...
exports.getDefaultWorkerCount = getDefaultWorkerCount;
const WORKER_CODE = `
